const posts = [
  ...
  {
    title: "How to turn a boring skate into a fun one.",
    slug: "how-to-turn-a-boring-skate-into-a-fun-one",
    date: "07/04/2020",
    html: `
		<p>
			<strong> Slowly build up momentum</strong>
		</p>

    <p>
      Today I went and skated a basketball court solo, I was having an allgood sesh then after about an hour i started to fade out and ended up just sitting down.
      I was about to leave when i saw the curb was double the height of an average curb around the whole park, so i tried like 180 50-50, it felt really good, so i tried 180 5-0 and that felt real good too. 
      Then i kept <strong> thinking of tricks </strong> i could do <strong>that would feel good to do.</strong>
      And before I knew it, I was in flow state hard, I had heaps of energy, and I was having heaps of fun. 
		</p>

    <p> 
      I think by starting off small, doing little tricks that feel good to do, then slowly building up from there is like a gateway to energy and fun. I hope you can always have a fun skate.
		</p>
